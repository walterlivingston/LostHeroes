...
@OnlyIn(Dist.CLIENT)
public class LHEnchantTileEntityRenderer extends TileEntityRenderer<LHEnchantTile> {
    ...
    public LHEnchantTileEntityRenderer(TileEntityRendererDispatcher p_i226010_1_) {
        super(p_i226010_1_);
    }

    public void render(LHEnchantTile p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
