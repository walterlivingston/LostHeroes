...
public class LHEnchantScreen extends ContainerScreen<LHEnchantContainer> {
    ...
    public LHEnchantScreen(LHEnchantContainer p_i51090_1_, PlayerInventory p_i51090_2_, ITextComponent p_i51090_3_) {
