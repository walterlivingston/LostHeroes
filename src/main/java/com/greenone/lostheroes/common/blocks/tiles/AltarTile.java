...
public class AltarTile extends BlockEntity {
    private static int cooldown = 0;

    public AltarTile(BlockPos p_155088_, BlockState p_155089_) {
        super(LHTileEntities.ALTAR, p_155088_, p_155089_);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, AltarTile tile) {
