...
public class LHItemModelProperties {
    public static void registerProperties(){
        ...
        for(Item crossbow : LHItems.crossbows.values()){
            ItemModelsProperties.register(crossbow, new ResourceLocation(LostHeroes.MOD_ID, "pull"), (p_239427_0_, p_239427_1_, p_239427_2_) -> {
                if (p_239427_2_ == null) {
                    return 0.0F;
                } else {
            ...
            ItemModelsProperties.register(crossbow, new ResourceLocation(LostHeroes.MOD_ID,"pulling"), (p_239426_0_, p_239426_1_, p_239426_2_) -> p_239426_2_ != null && p_239426_2_.isUsingItem() && p_239426_2_.getUseItem() == p_239426_0_ && !CrossbowItem.isCharged(p_239426_0_) ? 1.0F : 0.0F);
            ItemModelsProperties.register(crossbow, new ResourceLocation(LostHeroes.MOD_ID,"charged"), (p_239425_0_, p_239425_1_, p_239425_2_) -> p_239425_2_ != null && CrossbowItem.isCharged(p_239425_0_) ? 1.0F : 0.0F);
            ItemModelsProperties.register(crossbow, new ResourceLocation(LostHeroes.MOD_ID,"firework"), (p_239424_0_, p_239424_1_, p_239424_2_) -> p_239424_2_ != null && CrossbowItem.isCharged(p_239424_0_) && CrossbowItem.containsChargedProjectile(p_239424_0_, Items.FIREWORK_ROCKET) ? 1.0F : 0.0F);}
