    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        for(Metal m : Metal.values()){
            if(m == Metal.GOLD){
                ...
                if(m != Metal.COPPER) ShapedRecipeBuilder.shaped(LHBlocks.storageBlocks.get(m)).define('#', LHItems.ingots.get(m)).pattern("###").pattern("###").pattern("###").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ShapedRecipeBuilder.shaped(LHItems.ingots.get(m)).define('#', LHItems.nuggets.get(m)).pattern("###").pattern("###").pattern("###").group("iron_ingot").unlockedBy("has_" + m.tagName() + "_nugget", has(LHItems.nuggets.get(m))).save(consumer, new ResourceLocation(LostHeroes.MOD_ID, m.tagName() + "_ingot_from_nuggets"));
                ShapelessRecipeBuilder.shapeless(LHItems.nuggets.get(m), 9).requires(LHItems.ingots.get(m)).unlockedBy("has_" + m.tagName() + "_ingot", has(LHItems.ingots.get(m))).save(consumer);

                ShapedRecipeBuilder.shaped(LHItems.swords.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("X").pattern("X").pattern("#").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                if(m != Metal.COPPER) ShapelessRecipeBuilder.shapeless(LHItems.ingots.get(m), 9).requires(LHBlocks.storageBlocks.get(m)).unlockedBy("has_" + m.tagName() + "_block", has(LHBlocks.storageBlocks.get(m))).save(consumer, new ResourceLocation(LostHeroes.MOD_ID, m.tagName()+"_ingot_from_block"));
                ShapedRecipeBuilder.shaped(LHItems.axes.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ...
                ShapedRecipeBuilder.shaped(LHItems.hoes.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ShapedRecipeBuilder.shaped(LHItems.picks.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ShapedRecipeBuilder.shaped(LHItems.shovels.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("X").pattern("#").pattern("#").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ShapedRecipeBuilder.shaped(LHItems.bows.get(m)).define('#', LHItems.ingots.get(m)).define('X', Items.STRING).pattern(" #X").pattern("# X").pattern(" #X").unlockedBy("has_string", has(Items.STRING)).unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ...
                ShapedRecipeBuilder.shaped(LHItems.shields.get(m)).define('W', LHItems.ingots.get(m)).define('o', Items.IRON_INGOT).pattern("WoW").pattern("WWW").pattern(" W ").unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
                ShapedRecipeBuilder.shaped(LHItems.spears.get(m)).define('#', Items.STICK).define('X', LHItems.ingots.get(m)).pattern("  X").pattern(" # ").pattern("#  ").unlockedBy("has_" + m.tagName()+"_ingot", has(LHItems.ingots.get(m))).save(consumer);
            }
        }
