...
public enum LHArmorMaterials implements StringRepresentable, ArmorMaterial {
    COPPER("copper", 15, Util.make(new EnumMap<>(ArmorItem.Type.class), (armorType) -> {
        armorType.put(ArmorItem.Type.BOOTS, 2);
        armorType.put(ArmorItem.Type.LEGGINGS, 5);
        armorType.put(ArmorItem.Type.CHESTPLATE, 6);
        armorType.put(ArmorItem.Type.HELMET, 2);
    }), 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.IRON_INGOT);
    }),
    TIN("tin", 15, Util.make(new EnumMap<>(ArmorItem.Type.class), (armorType) -> {
        armorType.put(ArmorItem.Type.BOOTS, 2);
        armorType.put(ArmorItem.Type.LEGGINGS, 5);
        armorType.put(ArmorItem.Type.CHESTPLATE, 6);
        armorType.put(ArmorItem.Type.HELMET, 2);
...
//    });
    ...
    private LHArmorMaterials(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
